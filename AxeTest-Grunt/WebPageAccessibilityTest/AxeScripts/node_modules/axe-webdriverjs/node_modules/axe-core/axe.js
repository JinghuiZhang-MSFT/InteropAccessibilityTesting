        ...
        "data": {
            "rules": {
                ...
                "accesskeys": {
                    ...
                    "impact": "critical", "messages": {
                        "pass": function anonymous(it) {
                            var out = 'Element alt attribute is not just a image name or link but meaningful'; return out;
                        }, "fail": function anonymous(it) {
                            var out = 'Alt attribute is just a image name or link'; return out;
                        }
                    }
                }, "title-only": {
                    "impact": "serious", "messages": {
            ...
            "id": "accesskeys", "selector": "[accesskey]", "tags": ["wcag2a", "wcag211"], "all": [], "any": [], "none": [{
            ...
            "id": "area-alt", "selector": "map area[href]", "excludeHidden": false, "tags": ["wcag2a", "wcag111", "section508", "section508a"], "all": [], "any": [{
            ...
            "id": "aria-allowed-attr", "tags": ["wcag2a", "wcag411"], "all": [], "any": [{
            ...
            "id": "aria-required-attr", "selector": "[role]", "tags": ["wcag2a", "wcag411"], "all": [], "any": [{
            ...
            "id": "aria-required-children", "selector": "[role]", "tags": ["wcag2a", "wcag411"], "all": [], "any": [{
            ...
            "id": "aria-required-parent", "selector": "[role]", "tags": ["wcag2a", "wcag411"], "all": [], "any": [{
            ...
            "id": "aria-roles", "selector": "[role]", "tags": ["wcag2a", "wcag411"], "all": [], "any": [], "none": [{
            ...
            "id": "aria-valid-attr-value", "tags": ["wcag2a", "wcag411"], "all": [], "any": [{
            ...
            "id": "aria-valid-attr", "tags": ["wcag2a", "wcag411"], "all": [], "any": [{
                "id": "aria-valid-attr", "matches": function (node) {
                    var aria = /^aria-/;
                    if (node.hasAttributes()) {
                        var attrs = node.attributes;
                        for (var i = 0, l = attrs.length; i < l; i++) {
            ...
            "id": "audio-caption", "selector": "audio", "excludeHidden": false, "tags": ["wcag2a", "wcag122", "section508", "section508a"], "all": [], "any": [], "none": [{
            ...
            "id": "blink", "selector": "blink", "tags": ["wcag2a", "wcag411"], "all": [], "any": [], "none": [{
                "id": "exists", "evaluate": function (node, options) {
                    return true;
                }
            }]
        }, {
            "id": "button-name", "selector": "button, [role=\"button\"], input[type=\"button\"], input[type=\"submit\"], input[type=\"reset\"]", "tags": ["wcag2a", "wcag111", "section508", "section508a"], "all": [], "any": [{
            ...
            }, "tags": ["wcag2a", "wcag241", "section508", "section508o"], "all": [], "any": [{
            ...
            "id": "checkboxgroup", "selector": "input[type=checkbox][name]", "tags": ["wcag2a", "wcag131"], "all": [], "any": [{
            ...
            "id": "color-contrast", "selector": "*", "tags": ["wcag2aa", "wcag143"], "all": [], "any": [{
                "id": "color-contrast", "matches": function (node) {
            ...
            "id": "data-table", "selector": "table", "matches": function (node) {
                return commons.table.isDataTable(node);
            }, "tags": ["wcag2a", "wcag131"], "all": [], "any": [{
            ...
            "id": "definition-list", "selector": "dl", "tags": ["wcag2a", "wcag131"], "all": [], "any": [], "none": [{
                "id": "has-dlitems", "evaluate": function (node, options) {
            ...
            "id": "dlitem", "selector": "dd, dt", "tags": ["wcag2a", "wcag131"], "all": [], "any": [{
            ...
            "id": "document-title", "selector": "html", "tags": ["wcag2a", "wcag242"], "all": [], "any": [{
                "id": "doc-has-title", "evaluate": function (node, options) {
                    var title = node.ownerDocument.title;
                    return !!(title ? commons.text.sanitize(title).trim() : '');
                }
            }], "none": []
        }, {
            "id": "duplicate-id", "selector": "[id]", "tags": ["wcag2a", "wcag411"], "all": [], "any": [{
            ...
            "id": "empty-heading", "selector": "h1, h2, h3, h4, h5, h6, [role=\"heading\"]", "tags": ["wcag2a", "wcag131"], "all": [], "any": [{
            ...
            "id": "frame-title", "selector": "frame, iframe", "tags": ["wcag2a", "wcag241"], "all": [], "any": [{
            ...
            "id": "heading-order", "selector": "h1,h2,h3,h4,h5,h6,[role=heading]", "enabled": false, "tags": ["best-practice"], "all": [], "any": [{
            ...
            "id": "html-lang", "selector": "html", "tags": ["wcag2a", "wcag311"], "all": [], "any": [{
                "id": "has-lang", "evaluate": function (node, options) {
                    return node.hasAttribute('lang') || node.hasAttribute('xml:lang');
                }
            }], "none": [{
                "id": "valid-lang", "options": ["en", "es", "ja"], "evaluate": function (node, options) {
            ...
            "id": "image-altmeaning", "selector": "img", "tags": ["wcag2a", "wcag111", "section508", "section508a"], "all": [], "any": [{
                "id": "has-validalt", "evaluate": function (node, options) {
                    var label = node.getAttribute('alt');
                    return !commons.text.containsStr(label, '.png');
                }
            }], "none": []
        }, {
            "id": "image-alt", "selector": "img", "tags": ["wcag2a", "wcag111", "section508", "section508a"], "all": [], "any": [{
            ...
            "id": "input-image-alt", "selector": "input[type=\"image\"]", "tags": ["wcag2a", "wcag111", "section508", "section508a"], "all": [], "any": [{
                "id": "non-empty-alt", "evaluate": function (node, options) {
                    var label = node.getAttribute('alt');
                    return !!(label ? commons.text.sanitize(label).trim() : '');
                }
            ...
            "id": "label-title-only", "selector": "input:not([type='hidden']):not([type='image']):not([type='button']):not([type='submit']):not([type='reset']), select, textarea", "enabled": false, "tags": ["best-practice"], "all": [], "any": [], "none": [{
            ...
            "id": "label", "selector": "input:not([type='hidden']):not([type='image']):not([type='button']):not([type='submit']):not([type='reset']), select, textarea", "tags": ["wcag2a", "wcag332", "wcag131", "section508", "section508n"], "all": [], "any": [{
                "id": "aria-label", "evaluate": function (node, options) {
                    var label = node.getAttribute('aria-label');
                    return !!(label ? commons.text.sanitize(label).trim() : '');
                }
                ...
                "id": "help-same-as-label", "evaluate": function (node, options) {
            ...
            "id": "layout-table", "selector": "table", "matches": function (node) {
                return !commons.table.isDataTable(node);
            }, "tags": ["wcag2a", "wcag131"], "all": [], "any": [], "none": [{
            ...
            "id": "link-name", "selector": "a[href]:not([role=\"button\"]), [role=link][href]", "tags": ["wcag2a", "wcag111", "wcag412", "section508", "section508a"], "all": [], "any": [{
                "id": "has-visible-text", "evaluate": function (node, options) {
                    return commons.text.accessibleText(node).length > 0;
            ...
            "id": "list", "selector": "ul, ol", "tags": ["wcag2a", "wcag131"], "all": [], "any": [], "none": [{
            ...
            "id": "listitem", "selector": "li", "tags": ["wcag2a", "wcag131"], "all": [], "any": [{
            ...
            "id": "marquee", "selector": "marquee", "tags": ["wcag2a", "wcag222", "section508", "section508j"], "all": [], "any": [], "none": [{
                "id": "exists", "evaluate": function (node, options) {
                    return true;
                }
            }]
        }, {
            "id": "meta-refresh", "selector": "meta[http-equiv=\"refresh\"]", "excludeHidden": false, "tags": ["wcag2a", "wcag2aaa", "wcag221", "wcag224", "wcag325"], "all": [], "any": [{
            ...
            "id": "meta-viewport", "selector": "meta[name=\"viewport\"]", "excludeHidden": false, "tags": ["wcag2aa", "wcag144"], "all": [], "any": [{
            ...
            "id": "object-alt", "selector": "object", "tags": ["wcag2a", "wcag111"], "all": [], "any": [{
                "id": "has-visible-text", "evaluate": function (node, options) {
                    return commons.text.accessibleText(node).length > 0;
            ...
            "id": "radiogroup", "selector": "input[type=radio][name]", "tags": ["wcag2a", "wcag131"], "all": [], "any": [{
                "id": "group-labelledby", "evaluate": function (node, options) {
                    this.data({
                        name: node.getAttribute('name'),
                        type: node.getAttribute('type')
            ...
            "id": "region", "selector": "html", "pageLevel": true, "enabled": false, "tags": ["best-practice"], "all": [], "any": [{
            ...
            "id": "scope", "selector": "[scope]", "tags": ["wcag2a", "wcag411", "wcag131"], "all": [], "any": [{
            ...
            "id": "server-side-image-map", "selector": "img[ismap]", "tags": ["wcag2a", "wcag211", "section508", "section508f"], "all": [], "any": [], "none": [{
                "id": "exists", "evaluate": function (node, options) {
                    return true;
                }
            }]
        }, {
            "id": "skip-link", "selector": "a[href]", "pageLevel": true, "enabled": false, "tags": ["best-practice"], "all": [], "any": [{
            ...
            "id": "tabindex", "selector": "[tabindex]", "tags": ["wcag2a", "wcag243"], "all": [], "any": [{
            ...
            "id": "valid-lang", "selector": "[lang]:not(html), [xml\\:lang]:not(html)", "tags": ["wcag2aa", "wcag312"], "all": [], "any": [], "none": [{
                "id": "valid-lang", "options": ["en", "es", "ja"], "evaluate": function (node, options) {
                    var lang = (node.getAttribute('lang') || '').trim().toLowerCase();
                    var xmlLang = (node.getAttribute('xml:lang') || '').trim().toLowerCase();
                    var invalid = [];
            ...
            "id": "video-caption", "selector": "video", "tags": ["wcag2a", "wcag122", "wcag123", "section508", "section508a"], "all": [], "any": [], "none": [{
                "id": "caption", "evaluate": function (node, options) {
                    return !(node.querySelector('track[kind=captions]'));
            ...
            "id": "video-description", "selector": "video", "tags": ["wcag2aa", "wcag125", "section508", "section508a"], "all": [], "any": [], "none": [{
            ...
            text.containsStr = function (strDest, subStr) {
                'use strict';
                return strDest.indexOf(subStr) >= 0;
            };
